...
public class AccountFactory {
    public static Account getAccount(String rating, String website, String accountSite,
        ...
        return new Account(faker.company().name(), faker.phoneNumber().phoneNumber(), faker.phoneNumber().phoneNumber(),
                website, rating, faker.number().digits(5), accountSite, tickerSymbol, type,
                ownership, industry, faker.number().digits(1), faker.number().digits(5),
                faker.number().digits(5), faker.address().streetName(), faker.address().streetName(),
